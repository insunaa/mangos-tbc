      ...
      m_authLevel(AuthLevel::None), m_accountLevel(AccountTypes::SEC_PLAYER), m_accountId(0)
{
    ...
    {
        sLog.outError("Deprecated config option RA.Stricted being used.  Use "
                      "RA.Restricted instead.");
...
bool RASocket::HandleInput()
{
    ...
    case AuthLevel::None: {
        ...
        ///- allow by remotely connected admin use console level commands
        /// dependent
        /// from config setting
    ...
    ///< li> If the input is '<password>' (and the user already gave his
    ///< username)
