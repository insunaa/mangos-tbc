...
// FLAG_TO_ means, that in this case the linked NPC will also trigger an action
// for the NPC it is linked to
...
class CreatureLinkingMgr
{
  ...
  public: // Accessors
    ...
    // This function checks if the spawning of this NPC is dependend on other
    // NPCs
  ...
  private:
    ...
    // Storage of Data: npc_entry_slave, (map, npc_entry_master, flag,
    // master_db_guid[If Unique], search_range)
    CreatureLinkingMap m_creatureLinkingMap;
    // Storage of Data: npc_guid_slave, (map, npc_guid_master, flag,
    // master_db_guid, search_range)
 ...
 *
 * Every map has an instance of this class as member, in which the dynamic
 * information (GUIDs) are stored
 */
