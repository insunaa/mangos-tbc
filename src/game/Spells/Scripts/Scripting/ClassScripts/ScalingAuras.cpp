        ...
        case EFFECT_INDEX_1: // attack power
            if (Unit *owner = data.caster->GetOwner())
            {
                if (owner->IsPlayer())
                {
                    ...
                    int32 shadow =
                        int32(owner->GetUInt32Value(PLAYER_FIELD_MOD_DAMAGE_DONE_POS + SPELL_SCHOOL_SHADOW)) -
    ...
    int32 OnAuraValueCalculate(AuraCalcData &data, int32 value) const override
    {
        ...
        case EFFECT_INDEX_1: // attack power
            if (Unit *owner = data.caster->GetOwner())
            {
                ...
                {
                    int32 nature =
                        int32(owner->GetUInt32Value(PLAYER_FIELD_MOD_DAMAGE_DONE_POS + SPELL_SCHOOL_NATURE)) -
