...
class GMTicket
{
  public:
    ...
    explicit GMTicket(Field *fields)
    {
        Load(fields);
    }
    ...
    inline static std::string GetIdTag(uint32 id)
    {
        return ("T#" + std::to_string(id));
    }
    inline std::string GetIdTag() const
    {
        return GetIdTag(m_id);
    }
    inline uint8 GetCategory() const
    {
        return m_category;
    }
    inline GMTicketState GetState() const
    {
        return GMTicketState(m_state);
    }
    inline GMTicketEscalationStatus GetStatus() const
    {
        return m_status;
    }
    ...
    inline ObjectGuid const &GetAuthorGuid() const
    {
        return m_authorGuid;
    }
    inline const char *GetAuthorName() const
    {
    ...
    {
        return Position(m_x, m_y, m_z, m_o);
    }
    ...
    inline float GetPositionO() const
    {
        return m_o;
    }
    ...
    inline time_t GetCreatedAt() const
    {
        return m_created;
    }
    inline time_t GetUpdatedAt() const
    {
        return m_updated;
    }
    inline time_t GetSeenAt() const
    {
        return m_seen;
    }
    inline time_t GetAnsweredAt() const
    {
        return m_answered;
    }
    inline time_t GetClosedAt() const
    {
        return m_closed;
    }
    inline ObjectGuid const &GetAssigneeGuid() const
    {
        return m_assigneeGuid;
    }
    inline const char *GetAssigneeName() const
    {
        return m_assigneeName.c_str();
    }
    inline std::string const &GetConclusion() const
    {
        return m_conclusion;
    }
    inline std::string const &GetNotes() const
    {
        return m_notes;
    }

    inline bool IsAssignedTo(ObjectGuid guid) const
    {
        return (guid == m_assigneeGuid);
    }
    inline bool IsAssignedTo(const char *name) const
    {
        return (strcmp(m_assigneeName.c_str(), name) == 0);
    }

    inline bool IsAssigned() const
    {
        return (m_status == GMTICKET_ASSIGNEDTOGM_STATUS_ASSIGNED);
    }
    inline bool IsEscalated() const
    {
        return (m_status == GMTICKET_ASSIGNEDTOGM_STATUS_ESCALATED);
    }
    inline bool IsOpen() const
    {
        return (m_state == GMTICKET_STATE_OPEN);
    }
    inline bool IsSeen() const
    {
        return (m_seen > m_updated);
    }
    inline bool IsSurveyed() const
    {
        return (m_state == GMTICKET_STATE_CLOSED &&
                (m_statsEscalations || (m_statsChatIn >= 3 || m_statsChatOut >= 3)));
    }

    void AddNote(const std::string &line)
    {
        m_notes += ("\n" + line);
    }

    void SetState(GMTicketState state, time_t when = time(nullptr));
    void SetCategory(uint8 id)
    {
        m_category = id;
    }

    void SetAnswered(time_t when)
    {
        m_answered = when;
    }
    ...
    void SetConclusion(const std::string &response)
    {
        m_conclusion = response;
    }

    void UpdateStatsChat(bool incoming);

    inline time_t GetLastSeenAt() const
    {
        return m_statsLastSeen;
    }
  ...
  private:
    ...
    uint8 m_level;                     // Support level (Security level of the last account
...
class GMSurveyResult
{
  public:
    ...
    inline size_t GetAnswersCount() const
    {
        return m_answers.size();
    }
    inline uint32 GetTicketId() const
    {
        return m_ticketId;
    }
    inline uint32 GetSurveyId() const
    {
        return m_surveyId;
    }
    inline std::vector<uint8> const &GetAnswers() const
    {
        return m_answers;
    }
    inline std::string const &GetComment() const
    {
        return m_comment;
    }
...
class GMTicketMgr
{
  ...
  public:
    ...
    static inline float GetTicketAgeDays(time_t now, time_t created)
    {
        return GetDaysPassed(now, created);
    }
    inline float GetOldestTicketAgeDays() const
    {
        return m_statsOldestTicketAgeDays;
    }
    ...
    inline uint32 GenerateTicketId()
    {
  ...
  private:
    ...
    std::pair<GMTicket *, std::string> GetTicketByIdTag(const std::string &tag,
    ...
    CommandResult Close(GMTicket *ticket, const std::string &commentary, bool resolved,
    ...
    inline float GetAverageResolutionDays() const
    {
        return m_statsAverageResolutionDays;
    }
    inline size_t GetTicketCount() const
    {
