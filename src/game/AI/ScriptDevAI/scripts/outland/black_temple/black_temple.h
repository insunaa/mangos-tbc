...
class instance_black_temple : public ScriptedInstance
{
  public:
    ...
    GuidVector const &GetChannelersGuidList() const
    {
        return m_channelersGuidVector;
    }
    GuidVector const &GetGeneratorGuidVector() const
    {
        return m_creatureGeneratorGuidVector;
    }
    GuidVector &GetShadowyConstructGuidVector()
    {
        return m_shadowyConstructs;
    } // alterable
    void GetGlaiveTargetGuidVector(GuidVector &vector) const
    {
        vector = m_vGlaiveTargetGuidVector;
    }
    GuidVector &GetIllidanSpawns()
    {
        return m_illidanSpawns;
    }
    GuidVector &GetIllidanTriggersLower()
    {
        return m_illidanTriggersLower;
    }
    GuidVector &GetIllidanTriggersUpper()
    {
        return m_illidanTriggersUpper;
    }
    GuidVector &GetEnslavedSouls()
    {
        return m_enslavedSouls;
    }
