...
enum
{
    ...
    MIN_BASEMENT_MOBS = 45, // note: some DB provides have more spawns, up to 55.
                            // However we need to keep this compatible with all
    ...
    DATA_BASEMENT_EVENT = 1, // DO NOT CHANGE! Used by Acid. - used to check the
                             // mobs for the the basement event.
    ...
    // NPC_CHESS_SOUND_BUNNY        = 21921,                    // npc that
    // handles the encounter sounds NPC_WAITING_ROOM_STALKER     = 17459, //
    // trigger which marks the teleport location of the players; also used to
    // cast some control spells during the game
    NPC_SQUARE_WHITE = 17208, // chess white square
    NPC_SQUARE_BLACK = 17305, // chess black square
    // NPC_SQUARE_OUTSIDE_BLACK     = 17316,                    // outside chess
    // black square NPC_SQUARE_OUTSIDE_WHITE     = 17317,                    //
    // outside chess white square
...
class instance_karazhan : public ScriptedInstance
{
  public:
    ...
    uint32 GetPlayerTeam() const
    {
        return m_uiTeam;
    }
    bool IsFriendlyGameReady() const
    {
    ...
    GuidVector &GetAranTeleportNPCs()
    {
        return m_aranTeleportNPCs;
    }
