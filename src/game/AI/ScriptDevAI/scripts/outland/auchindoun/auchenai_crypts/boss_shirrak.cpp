...
struct boss_shirrakAI : public CombatAI
{
    ...
    {
        m_creature->RemoveAurasDueToSpell(SPELL_INHIBIT_MAGIC_TRIGGER); // TODO: Investigate passive spell
                                                                        // removal on death
    }
    ...
    void ExecuteAction(uint32 action) override
    {
        ...
        case SHIRRAK_CARNIVOROUS_BITE:
            if (DoCastSpellIfCan(m_creature, m_bIsRegularMode ? SPELL_CARNIVOROUS_BITE : SPELL_CARNIVOROUS_BITE_H) ==
                CAST_OK)
