...
enum
{
    ...
    SPELL_VOID_ZONE = 37063, // NOTE: all void zone spells have Consumption spell
    ...
    // spells which hit players (used only for visual - as seen from spell
    // description)
    ...
    // SPELL_CLEAR_NETHER_BEAM  = 37072,                // not clear how to use
    // this
...
// at first spawn portals got fixed coords, should be shuffled in subsequent
// beam phases
...
struct boss_netherspiteAI : public CombatAI
{
    ...
    void ExecuteAction(uint32 action) override
    {
        ...
        case NETHERSPITE_NETHERBREATH: {
            if (Unit *target = m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, SPELL_NETHERBREATH,
                                                                 SELECT_FLAG_PLAYER))
