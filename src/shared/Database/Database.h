...
class Database
{
  public:
    ...
    // must be called before first query in thread (one time for thread using one
  ...
  protected:
    ...
    std::atomic<bool> m_allowAsyncTransactions; ///< flag which specifies if async
