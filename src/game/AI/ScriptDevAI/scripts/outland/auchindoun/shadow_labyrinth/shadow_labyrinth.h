...
enum
{
    ...
    TYPE_HELLMAW = 1,
    // TYPE_OVERSEER           = 2,                            // obsolete id
    // used by acid
    TYPE_INCITER = 3,
    TYPE_VORPIL = 4,
    TYPE_MURMUR = 5,

    DATA_CABAL_RITUALIST = 1, // DO NOT CHANGE! Used by Acid. - used to check the
                              // Cabal Ritualists alive
...
class instance_shadow_labyrinth : public ScriptedInstance
{
  public:
    ...
    bool IsHellmawUnbanished() const
    {
        return m_sRitualistsAliveGUIDSet.empty();
    }
