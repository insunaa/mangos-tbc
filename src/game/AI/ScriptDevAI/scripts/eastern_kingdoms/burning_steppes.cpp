...
struct npc_grark_lorkrubAI : public npc_escortAI, private DialogueHelper
{
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        ...
        case 12:
            ...
            m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER, -7844.3f, -1521.6f, 139.2f, 0.0f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER, -7860.4f, -1507.8f, 141.0f, 6.0f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_BLACKROCK_RAIDER, -7845.6f, -1508.1f, 138.8f, 6.1f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_BLACKROCK_RAIDER, -7859.8f, -1521.8f, 139.2f, 6.2f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            break;
        case 24:
            ...
            m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER, -8035.3f, -1222.2f, 135.5f, 5.1f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_FLAMESCALE_DRAGONSPAWN, -8037.5f, -1216.9f, 135.8f, 5.1f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_BLACKROCK_AMBUSHER, -8009.5f, -1222.1f, 139.2f, 3.9f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_FLAMESCALE_DRAGONSPAWN, -8007.1f, -1219.4f, 140.1f, 3.9f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            break;
        case 28:
            m_creature->SummonCreature(NPC_SEARSCALE_DRAKE, -7897.8f, -1123.1f, 233.4f, 3.0f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
            m_creature->SummonCreature(NPC_SEARSCALE_DRAKE, -7898.8f, -1125.1f, 193.9f, 3.0f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
            m_creature->SummonCreature(NPC_SEARSCALE_DRAKE, -7895.6f, -1119.5f, 194.5f, 3.1f,
                                       TEMPSPAWN_TIMED_OOC_DESPAWN, 60000);
            break;
        case 30: {
            SetEscortPaused(true);
        ...
        case 45:
            ...
            m_creature->SummonCreature(NPC_HIGH_EXECUTIONER_NUZARK, -7532.3f, -1029.4f, 258.0f, 2.7f,
    ...
    void JustDidDialogueStep(int32 iEntry) override
    {
        ...
        case SAY_LEXLORT_1:
            ...
            break;
        case SAY_LEXLORT_3:
            // Note: this part isn't very clear. Should he just simply attack him,
            // or charge him?
        ...
        case NPC_GRARK_LORKRUB:
            // Fake death creature when the axe is lowered. This will allow us to
            // finish the event
                                             ...
                                             Creature *pCreatureTarget, ObjectGuid /*originalCasterGuid*/)
{
    ...
    {
        // Note: this implementation needs additional research! There is a lot of
