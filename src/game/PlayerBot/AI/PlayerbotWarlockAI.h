...
class PlayerbotWarlockAI : PlayerbotClassAI
{
  ...
  private:
    ...
    // DEMON SKILLS
    uint32 BLOOD_PACT, FIREBOLT, FIRE_SHIELD, ANGUISH, INTERCEPT, DEVOUR_MAGIC, FEL_INTELLIGENCE, SHADOW_BITE,
        SPELL_LOCK, LASH_OF_PAIN, SEDUCTION, SOOTHING_KISS, CONSUME_SHADOWS, SACRIFICE, SUFFERING, CLEAVE, TORMENT;
    ...
    bool m_isTempImp;      // True if imp summoned temporarily until soul shard
                           // acquired for demon of choice.
