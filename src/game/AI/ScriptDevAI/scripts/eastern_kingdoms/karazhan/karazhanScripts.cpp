...
SDName: Karazhan
SD%Complete: 100
SDComment: Quest support: 9645. Support for Barnes (Opera controller) and
Berthold (Doorman). SDCategory: Karazhan EndScriptData */
...
struct npc_barnesAI : public npc_escortAI, private DialogueHelper
{
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        ...
        case 5:
            ...
            m_creature->SummonCreature(NPC_SPOTLIGHT, -10895.27f, -1782.626f, 90.55984f, 3.769911f,
    ...
    if (ScriptedInstance *pInstance = (ScriptedInstance *)pCreature->GetInstanceData())
    {
        ...
        else
        {
            ...
            case FAIL:
                ...
                pPlayer->ADD_GOSSIP_ITEM_ID(GOSSIP_ICON_CHAT, gossipItemText, GOSSIP_SENDER_MAIN,
...
bool GossipSelect_npc_barnes(Player *pPlayer, Creature *pCreature, uint32 /*uiSender*/, uint32 uiAction)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 1:
        pPlayer->ADD_GOSSIP_ITEM_ID(GOSSIP_ICON_CHAT, GOSSIP_ITEM_OPERA_2, GOSSIP_SENDER_MAIN,
                                    GOSSIP_ACTION_INFO_DEF + 2);
...
enum
{
    ...
    // spells
    // Arcanagos
    // SPELL_NOTIFY_FLEE     = 30985,            // not used - allow Medivh to
    // return inside after the dragon has escaped SPELL_PREPARE_FIREBALL= 30970,
    // // not used - allow Medivh to cast fireball
    ...
    // SPELL_FLY_TO_DEATH    = 30936,            // not used - inform the dragon
    // to move to death Location
...
struct npc_image_of_medivhAI : public ScriptedAI, private DialogueHelper
{
    ...
    void SetEventStarter(ObjectGuid m_starterGuid)
    {
        m_eventStarterGuid = m_starterGuid;
    }
...
struct npc_image_arcanagosAI : public ScriptedAI
{
    ...
    void SpellHit(Unit *pCaster, const SpellEntry *pSpell) override
    {
        ...
        {
            // !!!Workaround Alert!!! - the spell should be cast on Medivh without
            // changing the unit flags!
                                               ...
                                               bool bIsStart)
{
    if (bIsStart && pSource->GetTypeId() == TYPEID_PLAYER)
    {
        ...
        if (Creature *pMedivh =
                ((Player *)pSource)
                    ->SummonCreature(NPC_IMAGE_OF_MEDIVH, afMedivhSpawnLoc[0], afMedivhSpawnLoc[1], afMedivhSpawnLoc[2],
                                     afMedivhSpawnLoc[3], TEMPSPAWN_DEAD_DESPAWN, 0))
        {
...
struct WrathOfTheTitansProcAura : public AuraScript
{
    ...
    SpellAuraProcResult OnProc(Aura *aura, ProcExecutionData &procData) const override
    {
        ...
        case SPELL_SCHOOL_FIRE:
            procData.triggeredSpellId = 30607;
            break; // Flame of Khaz'goroth
        case SPELL_SCHOOL_NATURE:
            procData.triggeredSpellId = 30606;
            break; // Bolt of Eonar
        case SPELL_SCHOOL_FROST:
            procData.triggeredSpellId = 30609;
            break; // Chill of Norgannon
        case SPELL_SCHOOL_SHADOW:
            procData.triggeredSpellId = 30608;
            break; // Spite of Sargeras
        case SPELL_SCHOOL_ARCANE:
            procData.triggeredSpellId = 30605;
