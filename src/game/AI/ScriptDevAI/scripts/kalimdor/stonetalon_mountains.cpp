...
struct npc_kayaAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        ...
        case 17:
            ...
            // apparently NPC say _after_ the ambush is over, and is most likely a
            // bug at you-know-where. we simplify this, and make say when the
            // ambush actually start.
            ...
            m_creature->SummonCreature(NPC_GRIMTOTEM_BRUTE, -40.05f, -510.89f, -46.05f, 1.7f,
                                       TEMPSPAWN_CORPSE_TIMED_DESPAWN, 30000);
