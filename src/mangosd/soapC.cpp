...
extern "C"
{
    ...
    SOAP_FMAC3 int SOAP_FMAC4 soap_putelement(struct soap *soap, const void *ptr, const char *tag, int id, int type)
    {
        ...
        case SOAP_TYPE_ns1__executeCommand:
            return soap_out_ns1__executeCommand(soap, tag, id, (const struct ns1__executeCommand *)ptr,
                                                "ns1:executeCommand");
        case SOAP_TYPE_ns1__executeCommandResponse:
        ...
        DBGLOG(TEST,
               SOAP_MESSAGE(fdebug, "soap_putelement '%s' failed for type %d in soapC.cpp\n", tag ? tag : "", type));
                                                                    ...
                                                                    struct SOAP_ENV__Code *a, const char *type)
{
    ...
    a = (struct SOAP_ENV__Code *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_SOAP_ENV__Code,
                                               sizeof(struct SOAP_ENV__Code), nullptr, nullptr, nullptr, nullptr);
    if (!a)
        return nullptr;
                                                                              ...
                                                                              const char *type)
{
    ...
    else
    {
        a = (struct ns1__executeCommand *)soap_id_forward(soap, soap->href, (void *)a, 0, SOAP_TYPE_ns1__executeCommand,
                                                          ...
                                                          sizeof(struct ns1__executeCommand), 0, soap_finsert, nullptr);
        if (soap->body && soap_element_end_in(soap, tag))
            return nullptr;
    }
    return a;
    ...
    struct soap *soap, const char *tag, struct ns1__executeCommandResponse *a, const char *type)
{
    ...
    a = (struct ns1__executeCommandResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns1__executeCommandResponse,
                                                            sizeof(struct ns1__executeCommandResponse), nullptr,
    ...
    else
    {
        a = (struct ns1__executeCommandResponse *)soap_id_forward(
            soap, soap->href, (void *)a, 0, SOAP_TYPE_ns1__executeCommandResponse,
            SOAP_TYPE_ns1__executeCommandResponse, sizeof(struct ns1__executeCommandResponse), 0, soap_finsert,
            nullptr);
        if (soap->body && soap_element_end_in(soap, tag))
            return nullptr;
    }
