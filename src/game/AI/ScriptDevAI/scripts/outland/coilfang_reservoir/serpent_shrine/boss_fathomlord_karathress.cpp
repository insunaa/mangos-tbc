...
struct boss_fathomguard_sharkkisAI : public CombatAI
{
    ...
    void ExecuteAction(uint32 action) override
    {
        ...
        case SHARKKIS_HURL_TRIDENT:
            if (Unit *target = m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, SPELL_HURL_TRIDENT,
                                                                 SELECT_FLAG_PLAYER))
        ...
        case SHARKKIS_THE_BEAST_WITHIN:
            ...
            {
                m_creature->CastSpell(nullptr, SPELL_BESTIAL_WRATH,
                                      TRIGGERED_OLD_TRIGGERED); // Pet part at pet
...
struct boss_fathomguard_caribdisAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff) override
    {
        ...
        {
            if (Unit *target = m_creature->SelectAttackingTarget(ATTACKING_TARGET_RANDOM, 0, SPELL_SUMMON_CYCLONE,
                                                                 SELECT_FLAG_PLAYER))
