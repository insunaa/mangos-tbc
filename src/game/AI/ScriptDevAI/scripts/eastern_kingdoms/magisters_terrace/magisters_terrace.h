...
enum
{
    ...
    GO_KAEL_DOOR = 188064,
    // GO_KAEL_STATUE_LEFT       = 188165,                  // animation statues
    // - they do not reset on fail GO_KAEL_STATUE_RIGHT      = 188166,
...
class instance_magisters_terrace : public ScriptedInstance
{
  public:
    ...
    bool IsKalecgosOrbHandled() const
    {
        return m_kalecgosOrbHandled;
    }
    void SetKalecgosOrbHandled()
    {
        m_kalecgosOrbHandled = true;
    }
