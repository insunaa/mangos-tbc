...
template <typename PathElem, typename PathNode = PathElem> class Path
{
  public:
    ...
    void push_back(const PathElem &node)
    {
    ...
    bool operator!=(Path<PathElem, PathNode> const &other) const
    {
        return i_nodes != other.i_nodes;
    }
