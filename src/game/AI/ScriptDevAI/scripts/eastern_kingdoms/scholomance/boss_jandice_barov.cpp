...
SD%Complete: 90
SDComment: Jandice's Illusions are missing their AoE immunity, they should only
be vunerable to direct damage (missing core feature ?) SDCategory: Scholomance
EndScriptData */
...
struct boss_jandicebarovAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff) override
    {
        ...
        {
            // Summon illusions and becomes invisible for 8 seconds while hiding
            // into the illusions
