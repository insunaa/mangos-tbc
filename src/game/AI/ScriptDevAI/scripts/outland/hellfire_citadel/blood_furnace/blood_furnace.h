...
enum
{
    ...
    // front right GO_PRISON_CELL_MAKER2        = 181814,               // The
    // maker cell back right GO_PRISON_CELL_MAKER3        = 181816, // The maker
    // cell front left GO_PRISON_CELL_MAKER4        = 181815,               //
    // The maker cell back left
...
class instance_blood_furnace : public ScriptedInstance
{
  ...
  private:
    ...
    uint32 m_uiBroggokEventTimer; // Timer for opening the event cages; 90s on
                                  // normal, 30s on heroic difficulty
