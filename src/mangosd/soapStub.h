...
struct SOAP_CMAC ns1__executeCommandResponse
{
  ...
  public:
    ...
    {
        return SOAP_TYPE_ns1__executeCommandResponse;
    }
...
struct SOAP_CMAC ns1__executeCommand
{
  ...
  public:
    ...
    long soap_type() const
    {
        return SOAP_TYPE_ns1__executeCommand;
    }
    /** Constructor with member initializations */
...
/* Type SOAP_ENV__Code is a recursive data type, (in)directly referencing
 * itself through its (base or derived class) members */
/* SOAP_ENV__Code: */
...
struct SOAP_CMAC SOAP_ENV__Detail
{
  public:
    char *__any;
    /** Any type of element 'fault' assigned to fault with its SOAP_TYPE_T
     * assigned to __type */
    /** Do not create a cyclic data structure throught this member unless SOAP
