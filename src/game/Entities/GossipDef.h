...
enum Gossip_Option
{
    ...
    GOSSIP_OPTION_UNLEARNPETSKILLS = 17, // UNIT_NPC_FLAG_TRAINER            (16) (bonus option for
...
class GossipMenu
{
  public:
    ...
    void SetDiscoveredNode()
    {
        m_discoveredNode = true;
    }
    bool IsJustDiscoveredNode() const
    {
    ...
    bool IsItemsDataEmpty() const
    {
        return m_gItemsData.empty();
    }
...
class PlayerMenu
{
  ...
  public:
    ...
    void SendQuestGiverRequestItems(Quest const *pQuest, ObjectGuid npcGUID, bool Completable,
