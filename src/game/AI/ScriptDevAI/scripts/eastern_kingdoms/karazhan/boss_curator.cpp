...
/* Pre-nerf Changes
Add Astral Armor ability - present whenever Curator is not evocating or
enraged.
...
struct boss_curatorAI : public CombatAI
{
    ...
    void Reset() override
    {
        ...
        //     m_creature->CastSpell(m_creature, SPELL_ASTRAL_ARMOR,
        //     TRIGGERED_NONE);
    }
    ...
    void JustSummoned(Creature *summoned) override
    {
        ...
        case NPC_ASTRAL_FLARE_4: {
            ...
            summoned->AI()->DoCastSpellIfCan(summoned, SPELL_ASTRAL_FLARE_PASSIVE,
                                             CAST_TRIGGERED | CAST_AURA_NOT_PRESENT);
            summoned->AI()->DoCastSpellIfCan(summoned, SPELL_ASTRAL_FLARE_VISUAL,
                                             CAST_TRIGGERED | CAST_AURA_NOT_PRESENT);
    ...
    void ExecuteAction(uint32 action) override
    {
        ...
        case CURATOR_ACTION_HATEFUL_BOLT: {
            if (Unit *pTarget =
                    m_creature->SelectAttackingTarget(ATTACKING_TARGET_TOPAGGRO, 1, nullptr, SELECT_FLAG_PLAYER))
