...
enum
{
    ...
    NPC_AYAMISS = 15369,
    NPC_OSSIRIAN = 15339,
    NPC_GENERAL_ANDOROV = 15471, // The general and the kaldorei are escorted for
                                 // the rajaxx encounter
...
class instance_ruins_of_ahnqiraj : public ScriptedInstance
{
  public:
    ...
    // bool IsEncounterInProgress() const override;              // not active in
    // AQ20
    ...
    void GetKaldoreiGuidList(GuidList &lList) const
    {
