...
SD%Complete: 95%
SDComment: TODO: Deathknight Understudy are supposed to gain Mind Exhaustion
debuff when released from player Mind Control SDCategory: Naxxramas
EndScriptData */
...
static const float resetZ = 285.0f; // Above this altitude, Razuvious is outside his combat area (in
                                    // the stairs) and should reset (leashing)
...
struct boss_razuviousAI : public CombatAI
{
    boss_razuviousAI(Creature *creature)
        : CombatAI(creature, RAZUVIOUS_ACTION_MAX),
    ...
    {
        // Every time a Deathknight Understudy taunts Razuvious, he will yell its
        // disappointment
