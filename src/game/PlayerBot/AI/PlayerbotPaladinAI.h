...
enum PaladinSpells
{
    ...
    JUDGEMENT_OF_THE_CRUSADER = 20303 // rank 5: 20302, rank 4: 20301, rank 3:
                                      // 20300, rank 2: 20188, rank 1: 21183
};
// class Player;
...
class PlayerbotPaladinAI : PlayerbotClassAI
{
  ...
  private:
    ...
    // Dispel disease or negative magic effects from an internally selected
    // target
    ...
    // make this public so the static function can access it. Either that or make
  ...
  public:
    ...
    uint32 GREATER_BLESSING_OF_KINGS, BLESSING_OF_KINGS, BLESSING_OF_PROTECTION, SHADOW_RESISTANCE_AURA, DEVOTION_AURA,
        FIRE_RESISTANCE_AURA, FROST_RESISTANCE_AURA, DEFENSIVE_STANCE, BERSERKER_STANCE, BATTLE_STANCE,
        DIVINE_PROTECTION, DIVINE_INTERVENTION, HOLY_SHIELD, AVENGERS_SHIELD, RIGHTEOUS_DEFENSE, BLESSING_OF_SANCTUARY,
