...
enum
{
    ...
    SPELL_CLEAR_ALL_SHACKLES = 29910, // Cast by Kel'Thuzad if more than three
                                      // Guardians of Icecrown are controlled

    MAX_SHACKLES = 3, // How many Guardians of Icecrown can be crowed control
                      // without Kel'Thuzad dispelling the shackles
...
// Used in Construct Quarter for the deadly blobs continuously spawning in
// Patchwerk corridor
