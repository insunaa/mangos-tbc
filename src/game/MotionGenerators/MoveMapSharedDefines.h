...
{
    NAV_AREA_EMPTY = 0,
    // areas 1-60 will be used for destructible areas (currently skipped in
    // vmaps, WMO with flag 1) ground is the highest value to make recast choose
    // ground over water when merging surfaces very close to each other (shallow
