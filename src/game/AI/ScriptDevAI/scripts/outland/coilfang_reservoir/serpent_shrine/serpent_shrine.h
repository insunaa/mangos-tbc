...
enum
{
    ...
    DATA_WATERSTATE_EVENT = 1, // DO NOT CHANGE! Used by Acid. - used to check
                               // the mobs for the water event.
...
class instance_serpentshrine_cavern : public ScriptedInstance
{
  public:
    ...
    void GetBeamHelpersGUIDList(GuidList &lList) const
    {
        lList = m_lBeamHelpersGUIDList;
    }
    void GetTinyTriggerGUIDList(GuidList &lList) const
    {
        lList = m_tinyTriggerGUIDList;
    }
