...
struct ScriptedAI : public CreatureAI
{
  public:
    ...
    // void DamageDeal(Unit* /*doneTo*/, uint32& /*damage*/, DamageEffectType
    // damagetype) override {}

    // Called at any Damage from any attacker (before damage apply) - dealer can
    // be nullptr during DOT tick void DamageTaken(Unit* /*dealer*/, uint32&
    // /*damage*/, DamageEffectType damagetype) override {}
    ...
    // unit void OwnerKilledUnit(Unit* /*victim*/) override {}
    ...
    // void SummonedMovementInform(Creature* /*summoned*/, uint32 /*motionType*/,
    ...
    // bool canReachByRangeAttack(Unit* who) override { return
    // UnitAI::canReachByRangeAttack(pWho); }
