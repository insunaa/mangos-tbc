...
class MoveSplineFlag
{
  public:
    enum eFlags : uint32
    {
        ...
        Enter_Cycle = 0x00200000, // Everytimes appears with cyclic flag in monster
                                  // move packet, erases first spline vertex after
                                  // first cycle done
    ...
    bool isSmooth() const
    {
        return (raw() & Mask_CatmullRom) != 0;
    }
    bool isFacing() const
    {
        return (raw() & Mask_Final_Facing) != 0;
    }
