...
enum
{
    ...
    TYPE_CHROMA_LBREATH = 9, // Not real events: used to store the two random
                             // Chromaggus breaths for the instance lifetime
    TYPE_CHROMA_RBREATH = 10,
    TYPE_NEFA_LTUNNEL = 11, // Not real events: used to store the two random
                            // drakonids selection for the instance lifetime
    ...
    // SPELL_SUMMON_LEGIONNAIRES   = 19824,                    // Periodically
    // triggers 19826
    ...
    SPELL_FIREBALL = 23024,       // Used by Razorgore to reset the event (and kill
                                  // everyone like a badass)
...
static const SpawnLocation aNefarianLocs[3] = {
    {-7599.32f, -1191.72f, 475.545f},    // opening where red/blue/black darknid
                                         // spawner appear (ori 3.05433)
...
// Coords used in intro event for Vaelastrasz to spawn Nefarius at the throne
// and sort the gobelins
