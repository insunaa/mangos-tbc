...
struct npc_ruul_snowhoofAI : public npc_escortAI
{
    ...
    void DoSpawnAmbush(uint8 index)
    {
        for (auto ambusherEntry : m_ruulAmbushers)
        {
            ...
            if (Creature *ambusher = m_creature->SummonCreature(ambusherEntry, fx, fy, fz, 0, TEMPSPAWN_DEAD_DESPAWN,
                                                                60 * IN_MILLISECONDS))
            {
...
bool QuestAccept_npc_ruul_snowhoof(Player *player, Creature *creature, const Quest *quest)
{
    ...
    {
        creature->SetFactionTemporary(FACTION_ESCORT_H_NEUTRAL_PASSIVE,
...
struct npc_torekAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        ...
        case 20:
            ...
            m_creature->SummonCreature(NPC_DURIEL, 1776.73f, -2049.06f, 109.83f, 1.54f, TEMPSPAWN_TIMED_OOC_DESPAWN,
                                       25000);
 ...
 * The summon coords and event sequence are guesswork based on the comments
 * from wowhead and wowwiki
 */
...
struct npc_feero_ironhandAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 uiPointId) override
    {
        ...
        case 30:
            ...
            m_creature->SummonCreature(NPC_BALIZAR_THE_UMBRAGE, aEliteSummonPositions[0][0],
                                       aEliteSummonPositions[0][1], aEliteSummonPositions[0][2],
                                       aEliteSummonPositions[0][3], TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_ALIGAR_THE_TORMENTOR, aEliteSummonPositions[1][0],
                                       aEliteSummonPositions[1][1], aEliteSummonPositions[1][2],
                                       aEliteSummonPositions[1][3], TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            m_creature->SummonCreature(NPC_CAEDAKAR_THE_VICIOUS, aEliteSummonPositions[2][0],
                                       aEliteSummonPositions[2][1], aEliteSummonPositions[2][2],
                                       aEliteSummonPositions[2][3], TEMPSPAWN_TIMED_OOC_DESPAWN, 20000);
            break;
        case 31:
            // Complete the quest
            if (Player *pPlayer = GetPlayerForEscort())
