...
class TargetedMovementGeneratorMedium : public MovementGeneratorMedium<T, D>, public TargetedMovementGeneratorBase
{
  ...
  public:
    ...
    Unit *GetCurrentTarget() const override
    {
    ...
    virtual bool RemoveOnInvalid() const
    {
        return true;
    };
  ...
  protected:
    ...
    virtual bool ShouldFaceTarget() const
    {
        return i_faceTarget;
    }
...
Backpedaling - when player is standing inside model, mob backs away with 2
second delay, likely for smoothness Fanning - likewise after 2 seconds, all
mobs spread out at a given target - has to be coordinated with all targets
which attack same victim
...
class ChaseMovementGenerator : public TargetedMovementGeneratorMedium<Unit, ChaseMovementGenerator>
{
  ...
  public:
    ...
    bool RemoveOnInvalid() const override
    {
        return false;
    }
    ...
    ChaseMovementMode GetCurrentMode() const
    {
        return m_currentMode;
    }
    virtual bool IsReachable() const override;

    virtual bool IsRemovedOnExpire() const override
    {
        return true;
    }
...
class FollowMovementGenerator : public TargetedMovementGeneratorMedium<Unit, FollowMovementGenerator>
{
  ...
  protected:
    ...
    static inline uint32 _getPollRateBase()
    {
        return 400;
    }
    static inline uint32 _getPollRateMax()
    {
        return 800;
    }
...
// to be able to compute new path before the end of the current path (in
// milliseconds)
