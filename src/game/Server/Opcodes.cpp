...
OpcodeHandler opcodeTable[NUM_MSG_TYPES] = {
    ...
    /*0x066*/
    {"CMSG_CONTACT_LIST", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleContactListOpcode},
    /*0x067*/
    {"SMSG_CONTACT_LIST", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x068*/
    ...
    /*0x0F6*/
    {"CMSG_MOVE_HOVER_ACK", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleMoveFlagChangeOpcode},
    /*0x0F7*/
    ...
    /*0x126*/
    {"CMSG_SET_FACTION_CHEAT", STATUS_NEVER, PROCESS_THREADUNSAFE, &WorldSession::Handle_Deprecated},
    /*0x127*/
    ...
    /*0x1FF*/
    {"MSG_LOOKING_FOR_GROUP", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLFGListQuery},
    /*0x200*/
    {"CMSG_SET_LOOKING_FOR_GROUP", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfgOpcode},
    /*0x201*/
    ...
    /*0x292*/
    {"CMSG_MEETINGSTONE_JOIN", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x293*/
    {"CMSG_MEETINGSTONE_LEAVE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x294*/
    ...
    /*0x2B9*/
    {"CMSG_SHOWING_HELM", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleShowingHelmOpcode},
    /*0x2BA*/
    {"CMSG_SHOWING_CLOAK", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleShowingCloakOpcode},
    /*0x2BB*/
    ...
    /*0x33B*/
    {"SMSG_INSTANCE_DIFFICULTY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x33C*/
    {"MSG_GM_RESETINSTANCELIMIT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x33D*/
    {"SMSG_MOTD", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x33E*/
    {"SMSG_MOVE_SET_FLIGHT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x33F*/
    {"SMSG_MOVE_UNSET_FLIGHT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x340*/
    {"CMSG_MOVE_FLIGHT_ACK", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x341*/
    {"MSG_MOVE_START_SWIM_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x342*/
    {"MSG_MOVE_STOP_SWIM_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x343*/
    {"SMSG_MOVE_SET_CAN_FLY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x344*/
    {"SMSG_MOVE_UNSET_CAN_FLY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x345*/
    {"CMSG_MOVE_SET_CAN_FLY_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleMoveFlagChangeOpcode},
    /*0x346*/
    {"CMSG_MOVE_SET_FLY", STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleMovementOpcodes},
    /*0x347*/
    {"CMSG_SOCKET_GEMS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSocketOpcode},
    /*0x348*/
    {"CMSG_ARENA_TEAM_CREATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x349*/
    {"SMSG_ARENA_TEAM_COMMAND_RESULT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x34A*/
    {"UMSG_UPDATE_ARENA_TEAM_OBSOLETE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x34B*/
    {"CMSG_ARENA_TEAM_QUERY", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamQueryOpcode},
    /*0x34C*/
    {"SMSG_ARENA_TEAM_QUERY_RESPONSE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x34D*/
    {"CMSG_ARENA_TEAM_ROSTER", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamRosterOpcode},
    /*0x34E*/
    {"SMSG_ARENA_TEAM_ROSTER", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x34F*/
    {"CMSG_ARENA_TEAM_INVITE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleArenaTeamInviteOpcode},
    /*0x350*/
    {"SMSG_ARENA_TEAM_INVITE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x351*/
    ...
    /*0x357*/
    {"SMSG_ARENA_TEAM_EVENT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x358*/
    ...
    /*0x35B*/
    {"SMSG_ARENA_TEAM_STATS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x35C*/
    {"CMSG_LFG_SET_AUTOJOIN", STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetAutoJoinOpcode},
    /*0x35D*/
    {"CMSG_LFG_CLEAR_AUTOJOIN", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgClearAutoJoinOpcode},
    /*0x35E*/
    {"CMSG_LFM_SET_AUTOFILL", STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmSetAutoFillOpcode},
    /*0x35F*/
    {"CMSG_LFM_CLEAR_AUTOFILL", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmClearAutoFillOpcode},
    /*0x360*/
    {"CMSG_ACCEPT_LFG_MATCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x361*/
    {"CMSG_DECLINE_LFG_MATCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x362*/
    {"CMSG_CANCEL_PENDING_LFG", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x363*/
    ...
    /*0x365*/
    {"CMSG_SET_LOOKING_FOR_MORE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfmOpcode},
    /*0x366*/
    {"CMSG_SET_LFG_COMMENT", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfgCommentOpcode},
    /*0x367*/
    {"SMSG_LFG_TIMEDOUT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x368*/
    {"SMSG_LFG_OTHER_TIMEDOUT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x369*/
    {"SMSG_LFG_AUTOJOIN_FAILED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x36A*/
    {"SMSG_LFG_AUTOJOIN_FAILED_NO_PLAYER", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x36B*/
    {"SMSG_LFG_LEADER_IS_LFM", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x36C*/
    {"SMSG_LFG_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x36D*/
    {"SMSG_LFG_UPDATE_LFM", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x36E*/
    {"SMSG_LFG_UPDATE_LFG", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x36F*/
    {"SMSG_LFG_UPDATE_QUEUED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x370*/
    {"SMSG_LFG_PENDING_INVITE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x371*/
    {"SMSG_LFG_PENDING_MATCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x372*/
    {"SMSG_LFG_PENDING_MATCH_DONE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x373*/
    {"SMSG_TITLE_EARNED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x374*/
    {"CMSG_SET_TITLE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetTitleOpcode},
    /*0x375*/
    {"CMSG_CANCEL_MOUNT_AURA", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleCancelMountAuraOpcode},
    /*0x376*/
    {"SMSG_ARENA_ERROR", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x377*/
    {"MSG_INSPECT_ARENA_TEAMS", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleInspectArenaTeamsOpcode},
    /*0x378*/
    {"SMSG_DEATH_RELEASE_LOC", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x379*/
    {"CMSG_CANCEL_TEMP_ENCHANTMENT", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleCancelTempEnchantmentOpcode},
    /*0x37A*/
    {"SMSG_FORCED_DEATH_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x37B*/
    {"CMSG_CHEAT_SET_HONOR_CURRENCY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x37C*/
    {"CMSG_CHEAT_SET_ARENA_CURRENCY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x37D*/
    {"MSG_MOVE_SET_FLIGHT_SPEED_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x37E*/
    {"MSG_MOVE_SET_FLIGHT_SPEED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x37F*/
    {"MSG_MOVE_SET_FLIGHT_BACK_SPEED_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x380*/
    {"MSG_MOVE_SET_FLIGHT_BACK_SPEED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x381*/
    {"SMSG_FORCE_FLIGHT_SPEED_CHANGE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x382*/
    {"CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    /*0x383*/
    {"SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x384*/
    {"CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK", STATUS_LOGGEDIN, PROCESS_THREADSAFE,
     &WorldSession::HandleForceSpeedChangeAckOpcodes},
    /*0x385*/
    {"SMSG_SPLINE_SET_FLIGHT_SPEED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x386*/
    {"SMSG_SPLINE_SET_FLIGHT_BACK_SPEED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x387*/
    {"CMSG_MAELSTROM_INVALIDATE_CACHE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x388*/
    {"SMSG_FLIGHT_SPLINE_SYNC", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x389*/
    {"CMSG_SET_TAXI_BENCHMARK_MODE", STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleSetTaxiBenchmarkOpcode},
    /*0x38A*/
    {"SMSG_JOINED_BATTLEGROUND_QUEUE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x38B*/
    {"SMSG_REALM_SPLIT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x38C*/
    ...
    /*0x38F*/
    {"SMSG_OFFER_PETITION_ERROR", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x390*/
    {"SMSG_TIME_SYNC_REQ", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x391*/
    {"CMSG_TIME_SYNC_RESP", STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleTimeSyncResp},
    /*0x392*/
    {"CMSG_SEND_LOCAL_EVENT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x393*/
    {"CMSG_SEND_GENERAL_TRIGGER", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x394*/
    {"CMSG_SEND_COMBAT_TRIGGER", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x395*/
    {"CMSG_MAELSTROM_GM_SENT_MAIL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x396*/
    {"SMSG_RESET_FAILED_NOTIFY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x397*/
    {"SMSG_REAL_GROUP_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x398*/
    {"SMSG_LFG_DISABLED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x399*/
    {"CMSG_ACTIVE_PVP_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x39A*/
    ...
    /*0x39D*/
    {"SMSG_UPDATE_COMBO_POINTS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x39E*/
    {"SMSG_VOICE_SESSION_ROSTER_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x39F*/
    {"SMSG_VOICE_SESSION_LEAVE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A0*/
    {"SMSG_VOICE_SESSION_ADJUST_PRIORITY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A1*/
    {"CMSG_VOICE_SET_TALKER_MUTED_REQUEST", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3A2*/
    {"SMSG_VOICE_SET_TALKER_MUTED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A3*/
    {"SMSG_INIT_EXTRA_AURA_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A4*/
    {"SMSG_SET_EXTRA_AURA_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A5*/
    {"SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A6*/
    {"SMSG_CLEAR_EXTRA_AURA_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3A7*/
    {"MSG_MOVE_START_DESCEND", STATUS_LOGGEDIN, PROCESS_THREADSAFE, &WorldSession::HandleMovementOpcodes},
    /*0x3A8*/
    {"CMSG_IGNORE_REQUIREMENTS_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3A9*/
    {"SMSG_IGNORE_REQUIREMENTS_CHEAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3AA*/
    {"SMSG_SPELL_CHANCE_PROC_LOG", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3AB*/
    {"CMSG_MOVE_SET_RUN_SPEED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3AC*/
    {"SMSG_DISMOUNT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3AD*/
    {"MSG_MOVE_UPDATE_CAN_FLY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3AE*/
    {"MSG_RAID_READY_CHECK_CONFIRM", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3AF*/
    {"CMSG_VOICE_SESSION_ENABLE", STATUS_AUTHED, PROCESS_THREADUNSAFE, &WorldSession::HandleVoiceSessionEnableOpcode},
    /*0x3B0*/
    {"SMSG_VOICE_PARENTAL_CONTROLS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3B1*/
    {"CMSG_GM_WHISPER", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3B2*/
    {"SMSG_GM_MESSAGECHAT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3B3*/
    {"MSG_GM_GEARRATING", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3B4*/
    {"CMSG_COMMENTATOR_ENABLE", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleCommentatorModeOpcode},
    /*0x3B5*/
    {"SMSG_COMMENTATOR_STATE_CHANGED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3B6*/
    {"CMSG_COMMENTATOR_GET_MAP_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3B7*/
    {"SMSG_COMMENTATOR_MAP_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3B8*/
    {"CMSG_COMMENTATOR_GET_PLAYER_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3B9*/
    {"SMSG_COMMENTATOR_GET_PLAYER_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3BA*/
    {"SMSG_COMMENTATOR_PLAYER_INFO", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3BB*/
    {"CMSG_COMMENTATOR_ENTER_INSTANCE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3BC*/
    {"CMSG_COMMENTATOR_EXIT_INSTANCE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3BD*/
    {"CMSG_COMMENTATOR_INSTANCE_COMMAND", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3BE*/
    {"SMSG_CLEAR_TARGET", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3BF*/
    {"CMSG_BOT_DETECTED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3C0*/
    {"SMSG_CROSSED_INEBRIATION_THRESHOLD", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3C1*/
    {"CMSG_CHEAT_PLAYER_LOGIN", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3C2*/
    {"CMSG_CHEAT_PLAYER_LOOKUP", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3C3*/
    {"SMSG_CHEAT_PLAYER_LOOKUP", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3C4*/
    {"SMSG_KICK_REASON", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3C5*/
    {"MSG_RAID_READY_CHECK_FINISHED", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE,
     &WorldSession::HandleRaidReadyCheckFinishedOpcode},
    /*0x3C6*/
    {"CMSG_COMPLAIN", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleComplainOpcode},
    /*0x3C7*/
    {"SMSG_COMPLAIN_RESULT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3C8*/
    {"SMSG_FEATURE_SYSTEM_STATUS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3C9*/
    {"CMSG_GM_SHOW_COMPLAINTS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3CA*/
    {"CMSG_GM_UNSQUELCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3CB*/
    {"CMSG_CHANNEL_SILENCE_VOICE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3CC*/
    {"CMSG_CHANNEL_SILENCE_ALL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3CD*/
    {"CMSG_CHANNEL_UNSILENCE_VOICE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3CE*/
    {"CMSG_CHANNEL_UNSILENCE_ALL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3CF*/
    {"CMSG_TARGET_CAST", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3D0*/
    {"CMSG_TARGET_SCRIPT_CAST", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3D1*/
    ...
    /*0x3D4*/
    {"SMSG_CHANNEL_MEMBER_COUNT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3D5*/
    {"CMSG_CHANNEL_VOICE_ON", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleChannelVoiceOnOpcode},
    /*0x3D6*/
    {"CMSG_CHANNEL_VOICE_OFF", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3D7*/
    {"CMSG_DEBUG_LIST_TARGETS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3D8*/
    {"SMSG_DEBUG_LIST_TARGETS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3D9*/
    {"SMSG_AVAILABLE_VOICE_CHANNEL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3DA*/
    {"CMSG_ADD_VOICE_IGNORE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3DB*/
    {"CMSG_DEL_VOICE_IGNORE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3DC*/
    {"CMSG_PARTY_SILENCE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3DD*/
    {"CMSG_PARTY_UNSILENCE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3DE*/
    {"MSG_NOTIFY_PARTY_SQUELCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3DF*/
    {"SMSG_COMSAT_RECONNECT_TRY", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3E0*/
    {"SMSG_COMSAT_DISCONNECT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3E1*/
    {"SMSG_COMSAT_CONNECT_FAIL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3E2*/
    {"SMSG_VOICE_CHAT_STATUS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3E3*/
    {"CMSG_REPORT_PVP_AFK", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleReportPvPAFK},
    /*0x3E4*/
    {"CMSG_REPORT_PVP_AFK_RESULT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3E5*/
    ...
    /*0x3E7*/
    {"SMSG_GUILD_BANK_LIST", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3E8*/
    ...
    /*0x3EF*/
    {"SMSG_USERLIST_ADD", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F0*/
    {"SMSG_USERLIST_REMOVE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F1*/
    {"SMSG_USERLIST_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F2*/
    {"CMSG_CLEAR_CHANNEL_WATCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3F3*/
    {"SMSG_INSPECT_TALENT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F4*/
    {"SMSG_GOGOGO_OBSOLETE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F5*/
    {"SMSG_ECHO_PARTY_SQUELCH", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F6*/
    {"CMSG_SET_TITLE_SUFFIX", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3F7*/
    {"CMSG_SPELLCLICK", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3F8*/
    {"SMSG_LOOT_LIST", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3F9*/
    {"CMSG_GM_CHARACTER_RESTORE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3FA*/
    {"CMSG_GM_CHARACTER_SAVE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x3FB*/
    {"SMSG_VOICESESSION_FULL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x3FC*/
    ...
    /*0x3FF*/
    {"CMSG_MAELSTROM_RENAME_GUILD", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x400*/
    {"CMSG_GET_MIRRORIMAGE_DATA", STATUS_LOGGEDIN, PROCESS_INPLACE, &WorldSession::HandleGetMirrorimageData},
    /*0x401*/
    {"SMSG_MIRRORIMAGE_DATA", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x402*/
    {"SMSG_FORCE_DISPLAY_UPDATE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x403*/
    {"SMSG_SPELL_CHANCE_RESIST_PUSHBACK", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x404*/
    ...
    /*0x406*/
    {"CMSG_KEEP_ALIVE", STATUS_NEVER, PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess},
    /*0x407*/
    {"SMSG_RAID_READY_CHECK_ERROR", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x408*/
    ...
    /*0x40B*/
    {"CMSG_SET_GRANTABLE_LEVELS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x40C*/
    {"CMSG_GRANT_LEVEL", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGrantLevel},
    /*0x40D*/
    {"CMSG_REFER_A_FRIEND", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleReferAFriend},
    /*0x40E*/
    {"MSG_GM_CHANGE_ARENA_RATING", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x40F*/
    {"CMSG_DECLINE_CHANNEL_INVITE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x410*/
    {"CMSG_GROUPACTION_THROTTLED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x411*/
    {"SMSG_OVERRIDE_LIGHT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x412*/
    {"SMSG_TOTEM_CREATED", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x413*/
    {"CMSG_TOTEM_DESTROYED", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleTotemDestroyed},
    /*0x414*/
    {"CMSG_EXPIRE_RAID_INSTANCE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x415*/
    {"CMSG_NO_SPELL_VARIANCE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x416*/
    ...
    /*0x417*/
    {"SMSG_QUESTGIVER_STATUS_MULTIPLE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x418*/
    ...
    /*0x41A*/
    {"CMSG_QUERY_SERVER_BUCK_DATA", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x41B*/
    {"CMSG_CLEAR_SERVER_BUCK_DATA", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_NULL},
    /*0x41C*/
    {"SMSG_SERVER_BUCK_DATA", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x41D*/
    {"SMSG_SEND_UNLEARN_SPELLS", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x41E*/
    {"SMSG_PROPOSE_LEVEL_GRANT", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x41F*/
    {"CMSG_ACCEPT_LEVEL_GRANT", STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleAcceptLevelGrant},
    /*0x420*/
    {"SMSG_REFER_A_FRIEND_FAILURE", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x421*/
    {"SMSG_SPLINE_MOVE_SET_FLYING", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x422*/
    {"SMSG_SPLINE_MOVE_UNSET_FLYING", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
    /*0x423*/
    {"SMSG_SUMMON_CANCEL", STATUS_NEVER, PROCESS_INPLACE, &WorldSession::Handle_ServerSide},
};
