...
enum
{
    ...
    SPELL_SEPARATION_ANXIETY = 23487, // Aura cast on himself by Garr, if adds move out of range, they
                                      // will cast spell 23492 on themselves
...
struct boss_garrAI : public CombatAI
{
    ...
    void Aggro(Unit * /*who*/) override
    {
        ...
        // Garr has a 100 yard aura to keep track of the distance of each of his
        // adds, they will enrage if moved out of it
