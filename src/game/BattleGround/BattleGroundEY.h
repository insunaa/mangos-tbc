...
enum EYWorldStates
{
    ...
    // WORLD_STATE_EY_BLOOD_ELF_TOWER_ALLIANCE_CONFLICT  = 2735, // unused on
    // retail WORLD_STATE_EY_BLOOD_ELF_TOWER_HORDE_CONFLICT     = 2736, // unused
    // on retail
    ...
    // WORLD_STATE_EY_FEL_REAVER_RUINS_ALLIANCE_CONFLICT = 2739, // unused on
    // retail WORLD_STATE_EY_FEL_REAVER_RUINS_HORDE_CONFLICT    = 2740, // unused
    // on retail

    WORLD_STATE_EY_MAGE_TOWER_ALLIANCE = 2730,
    WORLD_STATE_EY_MAGE_TOWER_HORDE = 2729,
    WORLD_STATE_EY_MAGE_TOWER_NEUTRAL = 2728,
    // WORLD_STATE_EY_MAGE_TOWER_ALLIANCE_CONFLICT       = 2741, // unused on
    // retail WORLD_STATE_EY_MAGE_TOWER_HORDE_CONFLICT          = 2742, // unused
    // on retail
    ...
    // WORLD_STATE_EY_DRAENEI_RUINS_ALLIANCE_CONFLICT    = 2738, // unused on
    // retail WORLD_STATE_EY_DRAENEI_RUINS_HORDE_CONFLICT       = 2737, // unused
    // on retail
...
enum EYGameObjects
{
    ...
    GO_EY_VISUAL_BANNER_ALLIANCE = 184381, // main capture point objects use art
                                           // kit for alliance / horde flags
...
enum EYEvents
{
    ...
    EVENT_NETHERSTORM_FLAG_SPELL = 13042,  // not used; called when player clicks
                                           // on flag; triggered from spell
};
...
// (0alliance,1horde,2neutral) all other event2 are just node Ids; see the next
// enum
enum EYScriptEvents
{
...
enum EYNodes
{
    // TODO: Re-change order after we drop battleground_event and associated
    // tables
...
class BattleGroundEY : public BattleGround
{
  ...
  private:
    ...
    void SetFlagCarrier(ObjectGuid guid)
    {
        m_flagCarrier = guid;
    }
    void ClearFlagCarrier()
    {
        m_flagCarrier.Clear();
    }
