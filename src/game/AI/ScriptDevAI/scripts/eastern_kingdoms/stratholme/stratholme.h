...
static const uint32 gates[] = {GO_PORT_TRAP_GATE_1, GO_PORT_TRAP_GATE_2, GO_PORT_TRAP_GATE_3, GO_PORT_TRAP_GATE_4};

static const uint32 plaguedCritters[] = {NPC_PLAGUED_RAT, NPC_PLAGUED_MAGGOT, NPC_PLAGUED_INSECT};
...
static const EventLocation defensePoints[] = {
    ...
    {3661.89f, -3192.89f, 126.691f}  // Barricades before the last one (Courtyard): in last position
                                     // for conveniently iterate over the table
};
...
static const EventLocation scourgeInvaders[] =                                           // Attack when players cleared
                                                                                         // some parts of the Bastion
...
static const EventLocation scarletLastStand[] = // Positions remaining Scarlet defenders will move to
