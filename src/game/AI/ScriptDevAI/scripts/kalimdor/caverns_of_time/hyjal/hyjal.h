...
enum
{
    ...
    SPELL_CHOOSE_TARGET_UNUSED = 32121, // Currently unused. Unknown what its purpose is, but it's cast by
                                        // Druid of the Claw c.3795
...
class instance_mount_hyjal : public ScriptedInstance
{
  ...
  public:
    ...
    void FailEvent();
    GuidVector GetOverrunSpawns(uint32 baseId)
    {
        return m_overrunSpawns[baseId];
    }
