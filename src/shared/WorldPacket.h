...
class WorldPacket : public ByteBuffer
{
  public:
    ...
    void SetReceivedTime(std::chrono::steady_clock::time_point receivedTime)
    {
  ...
  protected:
    Opcodes m_opcode;
    std::chrono::steady_clock::time_point m_receivedTime; // only set for a specific set of opcodes, for
                                                          // performance reasons.
};
#endif
