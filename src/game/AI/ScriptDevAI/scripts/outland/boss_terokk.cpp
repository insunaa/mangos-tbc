    ...
    void ExecuteAction(uint32 action) override
    {
        ...
        case TEROKK_COMBAT_ACTION_SPAWN_ACE:
            if (m_creature->GetHealthPercent() > 50.f)
                return;
            m_creature->SummonCreature(NPC_ACE, -3335.223f, 3431.947f, 426.3864f, 0.f, TEMPSPAWN_MANUAL_DESPAWN, 0,
                                       true, true);
            m_creature->SummonCreature(NPC_ACE, -3335.223f, 3431.947f, 426.3864f, 0.f, TEMPSPAWN_MANUAL_DESPAWN, 0,
                                       true, true);
            m_creature->SummonCreature(NPC_ACE, -3335.223f, 3431.947f, 426.3864f, 0.f, TEMPSPAWN_MANUAL_DESPAWN, 0,
...
bool ProcessEventId_event_summon_terokk(uint32 /*eventId*/, Object *source, Object * /*pTarget*/, bool /*isStart*/)
{
    ...
    if (player->GetMap()->SpawnedCountForEntry(NPC_TEROKK) == 0)
        player->SummonCreature(NPC_TEROKK, -3788.856f, 3507.526f, 286.8846f, 3.159046f,
                               TEMPSPAWN_TIMED_OOC_OR_DEAD_DESPAWN, 600000, true, false, 0, 0, 0, true);
    return true;
}
