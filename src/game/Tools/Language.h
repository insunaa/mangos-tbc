...
enum MangosStrings
{
    ...
    LANG_WAYPOINT_NOTFOUNDDBPROBLEM = 223, // Creature (GUID: %u) No waypoints found - This is a MaNGOS db
                                           // problem (single float).
    LANG_WAYPOINT_NOTFOUND_NPC = 224,      // Cannot access %s on map, maybe you are
                                           // too far away from its spawn location
    ...
    LANG_WAYPOINT_INFO_UNK_SCRIPTID = 250, // ScriptID set to non-existing id %u, add it to DBScriptsEngine and
                                           // reload the table.
    ...
    //                                    1180-1191 no longer in use (previously
    //                                    used by ahbot)
    ...
    LANG_COMMAND_TICKET_UNSEEN = 1514,         // "[%s]: Ticket has not been seen by a GM yet"
                                               //                                  = 1515-1519,        // Reserved
    //                                  for possible ticket commands and
    //                                  results
    ...
    LANG_COMMAND_TICKETS_LISTING_FOOTER = 1524, // "| Quick actions: |c00FFFFFF<Shift+click>|r on ticket id tag to
                                                // read the ticket"
                                                //                                  = 1525-1529,        // Reserved
    //                                  for possible ticket commands and
    //                                  results
    ...
    LANG_TICKET_BROADCAST_SURVEY = 1548,         // "[Tickets]: [%s] has been successfully surveyed"
                                                 //                                  = 1549              // Reserved
                                                 //                                  for potential ticket broadcast
    ...
    LANG_TICKET_DETAILS_LINE_SUMMARY = 1560,     // "| %s L|c00FFFFFF%u|r ticket #|c00FFFFFF%u|r in category:
                                                 // |c00FFFFFF%s|r (|c00FFFFFF%u|r)"
    LANG_TICKET_DETAILS_LINE_AUTHOR = 1561,      // "| Player: |Hplayer:%s|h|c00FFFFFF<%s>|r|h (GUID
                                                 // |c00FFFFFF%010u|r) [|c00FFFFFF%s|r] |c00FF1A1A%s|r"
    ...
    LANG_TICKET_DETAILS_LINE_ASSIGNED = 1568,    // "| Last assigned to: |Hplayer:%s|h|c00FFFFFF<%s>|r|h (GUID
                                                 // |c00FFFFFF%010u|r)"
    ...
    //                                  = 1580              // Reserved
    //                                  for potential ticket action
    //                                  string
    LANG_TICKETS_NOTIFICATIONS = 1581, // "Ticket notifications"
    //                                  = 1582-1590,        // Reserved
    //                                  for possible strings related to
    //                                  tickets
