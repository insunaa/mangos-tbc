...
enum
{
    ...
    FACTION_IRONFORGE = 122,     // Faction used by Phalanx when Plugger is killed (yes, friendly to
                                 // Alliance, Hostile to Horde, very strange)
...
class instance_blackrock_depths : public ScriptedInstance
{
  public:
    ...
    void GetArenaCrowdGuid(GuidSet &sCrowdSet) const
    {
        sCrowdSet = m_sArenaCrowdNpcGuids;
    }
    ...
    void GetBarDoorIsOpen(bool &bIsOpen) const
    {
        bIsOpen = m_bIsBarDoorOpen;
    }
