...
static const uint32 uiImprovedDemoralizingShout[5] = {IMPROVED_DEMORALIZING_SHOUT_1, IMPROVED_DEMORALIZING_SHOUT_2,
                                                      IMPROVED_DEMORALIZING_SHOUT_3, IMPROVED_DEMORALIZING_SHOUT_4,
                                                      IMPROVED_DEMORALIZING_SHOUT_5};

static const uint32 uiImprovedSlam[2] = {IMPROVED_SLAM_1, IMPROVED_SLAM_2};
...
class PlayerbotWarriorAI : PlayerbotClassAI
{
  ...
  private:
    ...
    uint32 DEFENSIVE_STANCE, BLOODRAGE, SUNDER_ARMOR, TAUNT, SHIELD_BASH, REVENGE, SHIELD_BLOCK, DISARM, SHIELD_WALL,
        SHIELD_SLAM, DEVASTATE, SHOCKWAVE, CONCUSSION_BLOW, SPELL_REFLECTION, STANCE_MASTERY, LAST_STAND;
    ...
    // Talents
    uint32 IMPROVED_DEMORALIZING_SHOUT, IMPROVED_SLAM;
