...
enum AreaFlags
{
    ...
    AREA_FLAG_NEED_FLY = 0x00001000,       // only Netherwing Ledge, Socrethar's Seat, Tempest Keep, The
                                           // Arcatraz, The Botanica, The Mechanar, Sorrow Wing Point,
                                           // Dragonspine Ridge, Netherwing Mines, Dragonmaw Base Camp,
                                           // Dragonmaw Skyway
    AREA_FLAG_UNUSED1 = 0x00002000,        // not used now (no area/zones with this flag set in 2.4.2)
    AREA_FLAG_OUTLAND2 = 0x00004000,       // outland zones? (only Circle of Blood Arena not have this
...
enum SpawnMask
{
    SPAWNMASK_REGULAR = (1 << REGULAR_DIFFICULTY), // any any maps without spawn modes
                                                   // (continents/subway) or in minimal spawnmode
...
enum FactionTemplateFlags
{
    ...
    FACTION_TEMPLATE_FLAG_ATTACK_PVP_ACTIVE_PLAYERS = 0x00001000, // faction will attack players that were involved in
                                                                  // PvP combats
};
...
enum UnitNameSummonTitle
{
    ...
    // UNITNAME_SUMMON_TITLE_MINION      = 3,               // 's Minion, summon
    // army, 0 spells in 2.4.3
