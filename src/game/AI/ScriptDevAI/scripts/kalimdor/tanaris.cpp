...
struct mob_aquementasAI : public ScriptedAI
{
    ...
    void Reset() override
    {
        ...
        m_creature->setFaction(FACTION_FRIENDLY); // TODO: Either do this way, or
                                                  // might require a DB change
    }
...
struct npc_oox17tnAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i) override
    {
        ...
        case 29:
            ...
            m_creature->SummonCreature(NPC_SCOFFLAW, -7488.02f, -4786.56f, 10.67f, 3.74f,
                                       TEMPSPAWN_CORPSE_TIMED_DESPAWN, 10000);
            m_creature->SummonCreature(NPC_SHADOW_MAGE, -7486.41f, -4791.55f, 10.54f, 3.26f,
            ...
            if (HasFollowState(STATE_FOLLOW_POSTEVENT))
            {
                if (m_uiPostEventTimer < uiDiff)
                {
                    ...
                    case 6:
                        ...
                        m_creature->GetMotionMaster()->MovePoint(POINT_ID_TO_WATER, m_afToWaterLoc[0],
                                                                 m_afToWaterLoc[1], m_afToWaterLoc[2]);
                        break;
                    }
