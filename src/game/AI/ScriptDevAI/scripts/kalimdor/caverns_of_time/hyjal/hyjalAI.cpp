...
static const HyjalYells aHyjalYell[] = {
    ...
    //{NPC_JAINA,  INCOMING, -1534002}, // No official source confirming this
    // text exists or was ever used
    ...
    //{NPC_THRALL, INCOMING, -1534011}, // No official source confirming this
    // text exists or was ever used
...
void hyjalAI::ReceiveAIEvent(AIEventType eventType, Unit *sender, Unit * /*invoker*/, uint32 miscValue)
{
    ...
    case AI_EVENT_CUSTOM_C: // Event failed due to exceeding max number of wave
                            // mobs
        Retreat();
        break;
