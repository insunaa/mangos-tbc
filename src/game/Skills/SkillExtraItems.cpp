...
void LoadSkillExtraItemTable()
{
    ...
    if (result)
    {
        ...
        do
        {
            ...
            {
                sLog.outError("Skill specialization %u have nonexistent "
            ...
            {
                sLog.outError("Skill specialization %u has too low additional create "
            ...
            if (!additionalMaxNum)
            {
                sLog.outError("Skill specialization %u has 0 max number of extra items "
