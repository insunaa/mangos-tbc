...
enum SpellCastTargetFlags
{
    ...
    TARGET_FLAG_UNIT_RAID = 0x00000004,       // not used in any spells as of 2.4.3
                                              // (can be set dynamically) - raid member
    TARGET_FLAG_UNIT_PARTY = 0x00000008,      // not used in any spells as of 2.4.3
    ...
    TARGET_FLAG_UNIT_MINIPET = 0x00010000,    // pguid, not used in any spells as
                                              // of 2.4.3 (can be set dynamically)
};
...
enum SpellTargetImplicitType
{
    ...
    TARGET_TYPE_SPECIAL_DEST, // overrides existing targets with custom logic -
                              // Persistent AA
