...
class ByteBuffer
{
  public:
    ...
    void read(std::string &value, bool utf8)
    {
        ...
        // Detect invalid unicode sequence in string and raise appropriate
        // exception
...
template <> inline void ByteBuffer::read_skip<char const *>()
{
    read_skip<char *>();
}

template <> inline void ByteBuffer::read_skip<std::string>()
{
    read_skip<char *>();
}
#endif
