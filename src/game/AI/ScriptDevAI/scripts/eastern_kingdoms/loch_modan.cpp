...
SDName: Loch_Modan
SD%Complete: 100
SDComment: Quest support: 3181 (only to argue with pebblebitty to get to
searing
gorge, before quest rewarded), 309 SDCategory: Loch Modan EndScriptData */
                                              ...
                                              uint32 uiAction)
{
    ...
    case GOSSIP_ACTION_INFO_DEF + 6:
        pPlayer->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, "Done, done, and done.", GOSSIP_SENDER_MAIN,
