...
struct GameEventData
{
    ...
    bool isValid() const
    {
        return scheduleType == GAME_EVENT_SCHEDULE_SERVERSIDE || length > 0;
    }
};
...
class GameEventMgr
{
  public:
    ...
    std::unordered_map<uint32, std::vector<uint32>> const &GetEventGroups() const
    {
        return m_gameEventGroups;
    }
