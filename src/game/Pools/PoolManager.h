...
struct PoolTemplateData
{
    ...
    // this case this is not important. nullptr is no spawns by some reason
    uint32 MaxLimit;
...
class PoolManager
{
  public:
    ...
    // Method that tell if the creature/gameobject/pool is part of top level pool
    // and return the pool id if yes
    ...
    // used for calling from global systems when need initialize spawn pool state
    // in appropriate (possible) map persistent state
