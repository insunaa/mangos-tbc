...
enum
{
    ...
    SPELL_LAUGH = 33716, // used during incite chaos onto one player every 2-4
                         // seconds TODO: add usage
    ...
    // npcs summoned during incite chaos, each one charms a different player -
    // propagates factions above to them
