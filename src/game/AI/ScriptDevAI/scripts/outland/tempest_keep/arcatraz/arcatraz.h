...
enum
{
    ...
    TYPE_DALLIAH = 2,
    TYPE_SOCCOTHRATES = 3,
    TYPE_HARBINGERSKYRISS = 4, // Handled with ACID (FAIL of 20905, 20906, 20908,
                               // 20909, 20910, 20911)
    TYPE_WARDEN_1 = 5,         // Handled with ACID (20905 - Blazing Trickster, 20906 - Phase-Hunter)
    TYPE_WARDEN_2 = 6,
    TYPE_WARDEN_3 = 7, // Handled with ACID (20908 - Akkiris Lightning-Waker,
                       // 20909 - Sulfuron Magma-Thrower)
    TYPE_WARDEN_4 = 8, // Handled with ACID (20910 - Twilight Drakonaar, 20911 -
                       // Blackwing Drakonaar)
    TYPE_WARDEN_5 = 9,
