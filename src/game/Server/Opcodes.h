...
// Note: this include need for be sure have full definition of class
// WorldSession
//       if this class definition not complite then VS for x64 release use
//       different size for struct OpcodeHandler in this header and Opcode.cpp
//       and get totally wrong data from table opcodeTable in source when
//       Opcode.h included but WorldSession.h not included
...
// Don't forget to change this value and add opcode name to Opcodes.cpp when
// you add new opcode!
