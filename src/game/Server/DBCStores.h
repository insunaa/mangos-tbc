...
// accessed using function, no usable index
...
// Zone2MapCoordinates and Map2ZoneCoordinates extern DBCStorage
// <WorldMapOverlayEntry>         sWorldMapOverlayStore; -- not used currently
